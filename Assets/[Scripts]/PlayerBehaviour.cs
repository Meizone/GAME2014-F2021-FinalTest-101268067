...
public class PlayerBehaviour : MonoBehaviour
{
    ...
    {
        if (col.gameObject.CompareTag("Floating Platform"))
        {
            col.gameObject.GetComponent<FloatingPlatform>().isActive = true;
        }
    }
    ...
    private void OnTriggerExit2D(Collider2D col)
    {
        if (col.gameObject.CompareTag("Floating Platform"))
        {
            col.gameObject.GetComponent<FloatingPlatform>().isActive = false;
            Debug.Log("Im off of ere!");
        }
    }
